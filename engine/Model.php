...
class Model {
    ...
    public function insert(array $data, ?string $target_table = null): ?int {
        if (!isset($target_table)) {
            $target_table = $this->get_table_from_url(); //Bash
        }
    ...
    /**
     * Checks if a table exists in the database and optionally verifies if a column exists in that table.
     *
     * @param string $table_name The name of the table to check.
     * @param string|null $column_name (optional) The name of the column to check.
     * @return bool Returns true if the table (and column if specified) exists, false otherwise.
     */
