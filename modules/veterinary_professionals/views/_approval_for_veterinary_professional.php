            ...
            <div class="card shadow p-4">
                ...
                <div class="service-span">
                    ...
                    <div>
                        ...
                        <div class="div-content">
                            <div>Applied:</div>
                            <h5><?= $vet_professional->reg_date; ?></h5>
                        </div>                        
                    </div>
                </div>
                <hr>
                <div class="service-span">
                    <h5>Contat Details</h5>
                    <div>
                        <div class="div-content">
                            <div>Firstname</div>
                ...
                <div class="service-span-upload-document">
                    ...
                    <div>
                        <div class="div-content">
                            ...
                            <div class="upload-document"><img src="<?= THEME_DIR?>img/file-icon.png" alt="" class="fa-file-icon"> Dr <?= ucwords($vet_professional->firstname.' '.$vet_professional->lastname.'.Pdf');?></div>
                        </div>
                    </div>
                </div>                            
            </div>
