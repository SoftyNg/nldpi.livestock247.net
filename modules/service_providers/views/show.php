...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('serviceprovidersregisters/manage', 'View All Serviceprovidersregisters', array("class" => "button alt"));
        echo anchor('serviceprovidersregisters/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                <div class="row">
                    <div>ndlpi_number</div>
                    <div><?= out($ndlpi_number) ?></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('serviceprovidersregisters/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a ServiceProvidersRegister record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
