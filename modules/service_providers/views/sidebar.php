...
<?= (current_url() == BASE_URL . 'serviceprovidersregisters/dashboard') ? 'active' : ''; ?>

">

    <?= anchor('dashboard', 

    '<i class="fa fa-home"></i><span>Dashboard</span>', ['class' => 'nav-link']); ?>
...
<?= (current_url() == BASE_URL . 'serviceprovidersregisters/number_bank_request') ? 'active' : ''; ?>

">

    <?= anchor('number_bank_request', 

    '<i class="fas fa-fw fa-table"></i><span>Number banks</span>', ['class' => 'nav-link']); ?>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    <span class="rounded-circle bg-user-initials">ET</span>
