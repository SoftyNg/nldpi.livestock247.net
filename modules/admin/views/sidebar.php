...
<ul class="navbar-nav bg-gradient-nlpdi-green sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?= (current_url() == BASE_URL . 'admin/dashboard') ? 'active' : ''; ?>">
        <?= anchor('dashboard', '<i class="fa fa-home"></i><span>Dashboard</span>', ['class' => 'nav-link']); ?>
    </li>
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item <?= (current_url() == BASE_URL . 'admin/user_registration_approval') ? 'active' : ''; ?>">
        <?= anchor('user_registration_approval', '<i class="fas fa-fw fa-table"></i><span>User Registration</span>', ['class' => 'nav-link']); ?>
    </li>
