...
<div class="container-fluid pt-3" style="background-color:#F5FCF9;">
    <div class="register-animal-form my-4 px-4">
        <?php echo form_open_upload($form_location);?>
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <?php
                            ...
                            echo form_dropdown('status', $status_options, $status, $attr1);
                        ?>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <?php
                            ...
                            echo form_label('Additional Note');
                            echo form_textarea('additional_note', $additional_note,  $attr1);
                        ?>
                        <span class="text-danger"><?php  echo (!empty(validation_errors('additional_note')) ? validation_errors('additional_note') : ''); ?></span>
                    </div>
                </div> 
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
            ...
            <div class="form-footer d-flex justify-content-between"> 
                ...
                <div id="step1Buttons" class="step-buttons d-flex flex-row"> 
                    ...
                    echo form_submit('submit', ($update_id>0) ?  'Update' : 'Register', $btn_submit_application_attr);
                    ?>
                </div>
            </div>
        <?php echo form_close(); ?>
