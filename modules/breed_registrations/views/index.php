                ...
                <div class="card-body">
                    <div class="no-gutters align-items-center">
                        <div class="animal-registered-container">
                         ...
                         <div class="h5 mb-0 font-weight-bold text-gray-800 mt-2"><?= number_format($total_registered_breed) ?></div>
                ...
                <div class="card-body">
                    <div class="no-gutters align-items-center">
                        <div class="animal-registered-container">
                         ...
                         <div class="h5 mb-0 font-weight-bold text-gray-800 mt-2"><?= number_format($total_registered_local_breed) ?></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="no-gutters align-items-center">
                        <div class="animal-registered-container">
                         ...
                         <div class="h5 mb-0 font-weight-bold text-gray-800 mt-2"><?= number_format($total_registered_exotic_breed) ?></div>
                    </div>
                </div>
            </div>
        </div>
