<?php
/**
 * Digital Registry View
 * Displays registration options and view links for various livestock ecosystem entities.
 */
?>
...
<div class="content-wrapper">
    ...
    <div class="service-container">
        <div class="service-container-1">
            ...
            <!-- Livestock Identification Service Providers -->
            <div class="service">
            ...
            <div class="service">
                ...
                <p>Register your vehicle for the transportation of livestock. Ensure compliance with health, safety, and traceability standards across covered regions.</p>
                <div class="mt-3">
